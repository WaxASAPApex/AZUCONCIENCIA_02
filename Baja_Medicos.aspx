<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Baja_Medicos.aspx.cs" Inherits="AZUCONCIENCIA_02.Baja_Medicos" %>
...
<body>
    ...
    <form id="form1" runat="server" class="formulario">
        ...
        <asp:GridView ID="gvCitas" runat="server" AutoGenerateColumns="False" DataKeyNames="MedicoID" DataSourceID="sqlMedico" CssClass="gridview">
            <Columns>
        ...
        <table>
            <tr>
                ...
                <td>
                    <asp:Label ID="lbCitas" runat="server" Text="Ingresa el ID del Médico que quieres eliminar:" CssClass="etiqueta"></asp:Label>
                </td>
                <td>
             ...
             <tr>
                <td>
                    <asp:ValidationSummary ID="MedicosErrores" runat="server" CssClass="Error" Width="195px" />
                </td>
            </tr>
            <tr>
                <td>
