<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Consulta_Pacientes.aspx.cs" Inherits="AZUCONCIENCIA_02.Consulta_Pacientes" %>
...
<body>
  ...
  <form id="form1" runat="server" class="formulario">
        ...
        <asp:GridView ID="gbMedico" runat="server" AutoGenerateColumns="False" DataKeyNames="PacienteID" DataSourceID="sqlPaciente" CssClass="gridview">
            <Columns>
