<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Baja_Citas.aspx.cs" Inherits="AZUCONCIENCIA_02.Baja_Citas" %>
...
<img src="imagenes/azucologo.jpeg" />
 ...
 <!-- Formulario con estilos aplicados mediante CssClass -->
    ...
    <form id="form1" runat="server" class="formulario">
        ...
        <asp:GridView ID="gvCitas" runat="server" AutoGenerateColumns="False" DataKeyNames="CitaID" DataSourceID="sqlCitas" CssClass="gridview">
            <Columns>
        ...
        <table>
            <tr>
                ...
                <td>
                    <asp:Label ID="lbCitas" runat="server" Text="Ingresa el ID de la cita que quieres eliminar:" CssClass="etiqueta"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="tbCitas" runat="server" CssClass="cuadro-texto"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:ValidationSummary ID="errorCitas" runat="server" CssClass="Error" /><br />
                </td>
            </tr>
            <tr>
                <td>
