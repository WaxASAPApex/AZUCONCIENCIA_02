<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Consulta_Servicios.aspx.cs" Inherits="AZUCONCIENCIA_02.Consulta_Servicios" %>
...
<img src="imagenes/azucologo.jpeg" />
  ...
  <!-- Formulario con estilos aplicaos mediante CssClass -->
    <center>
    <form id="form1" runat="server" class="formulario">
        <!-- GridView con clases CSS aplicadas -->
        <asp:GridView ID="gbMedico" runat="server" AutoGenerateColumns="False" DataKeyNames="ConsultorioID" DataSourceID="sqlConsultorio" CssClass="gridview">
            <Columns>
                <asp:BoundField DataField="ConsultorioID" HeaderText="ConsultorioID" InsertVisible="False" ReadOnly="True" SortExpression="ConsultorioID" />
