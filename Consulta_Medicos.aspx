<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Consulta_Medicos.aspx.cs" Inherits="AZUCONCIENCIA_02.Consulta_Medicos" %>
...
<img src="imagenes/azucologo.jpeg" />
  ...
  <!-- Formulario con estilos aplicados mediante CssClass -->
    ...
    <form id="form1" runat="server" class="formulario">
        ...
        <asp:GridView ID="gbMedico" runat="server" AutoGenerateColumns="False" DataKeyNames="MedicoID" DataSourceID="sqlMedico" CssClass="gridview">
            <Columns>
